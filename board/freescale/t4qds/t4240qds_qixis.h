...
#ifndef __T4240QDS_QIXIS_H__
#define __T4240QDS_QIXIS_H__

/* QIXIS (FPGA) register bits — T4240QDS; see also board/freescale/t4qds/eth.c */

/* BRDCFG4[7:5]: EMI1 MDIO mux (RGMII vs AMC slots); paired with EC1/EC2 routing */

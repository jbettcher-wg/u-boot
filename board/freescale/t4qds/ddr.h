...
/*
 * Six DIMM sockets (two per DDR controller). Board-specific timing tables use
 * one set of parameters for all slots; split per-controller tables here if
 * future DIMM mixes require it.
 */

...
#define CFG_SYS_PCIE1_MEM_PHYS	0x4000000000ull
#define CFG_SYS_PCIE1_MEM_SIZE	0x800000000ull
#define CFG_SYS_PCIE1_IO_VIRT	0xf8000000
#define CFG_SYS_PCIE1_IO_PHYS	0xff8000000ull
#define CFG_SYS_PCIE1_MEM_PHYS_NONPREF	0xc00000000ull

#define CFG_SYS_PCIE2_MEM_VIRT	0xa0000000
#define CFG_SYS_PCIE2_MEM_PHYS	0x4800000000ull
#define CFG_SYS_PCIE2_MEM_SIZE	0x800000000ull
#define CFG_SYS_PCIE2_IO_VIRT	0xf8010000
#define CFG_SYS_PCIE2_IO_PHYS	0xff8010000ull
#define CFG_SYS_PCIE2_MEM_PHYS_NONPREF	0xc20000000ull

#define CFG_SYS_PCIE3_MEM_VIRT	0xc0000000
/* DT "ranges" for pcie@ffe260000: 32 GiB @ 0x5000000000 (see t4240qds.dts). */
#define CFG_SYS_PCIE3_MEM_PHYS	0x5000000000ull
#define CFG_SYS_PCIE3_MEM_SIZE	0x800000000ull
#define CFG_SYS_PCIE3_ADDR	(CONFIG_SYS_IMMR + CFG_SYS_MPC85xx_PCIE3_OFFSET)
#define CFG_SYS_PCIE3_MEM_PHYS_NONPREF	0xc80000000ull
#define CFG_SYS_PCIE4_MEM_BUS	0xe0000000
#define CFG_SYS_PCIE4_MEM_PHYS	0x5800000000ull
#define CFG_SYS_PCIE4_MEM_SIZE	0x800000000ull
#define CFG_SYS_PCIE4_ADDR	(CONFIG_SYS_IMMR + CFG_SYS_MPC85xx_PCIE4_OFFSET)
#define CFG_SYS_PCIE4_MEM_PHYS_NONPREF	0xc60000000ull
